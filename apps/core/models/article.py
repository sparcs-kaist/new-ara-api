...
class Article(MetaDataModel):
    ...
    name_type: int = models.PositiveSmallIntegerField(
    ...
    hit_count: int = models.PositiveIntegerField(
        verbose_name="조회수",
        default=0,
    )
    comment_count: int = models.PositiveIntegerField(
        verbose_name="댓글 수",
        default=0,
    )
    report_count: int = models.PositiveIntegerField(
        verbose_name="신고 수",
        default=0,
    )
    positive_vote_count: int = models.PositiveIntegerField(
        verbose_name="좋아요 수",
        default=0,
    )
    negative_vote_count: int = models.PositiveIntegerField(
        verbose_name="싫어요 수",
        default=0,
    )
    migrated_hit_count: int = models.PositiveIntegerField(
        verbose_name="이전된 조회수",
        default=0,
    )
    migrated_positive_vote_count: int = models.PositiveIntegerField(
