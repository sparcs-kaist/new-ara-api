...
from apps.user.views.notification_preference import NotificationPreferenceView
...
urlpatterns = [
    ...
    path("api/me/notification_preference", NotificationPreferenceView.as_view(), name="notification_preference"),
