...
class HomeView(views.APIView):
    def get(self, request, format=None):
        return response.Response(data={
            'daily_bests': {
                'positive_vote_count': _best_articles('daily', 'positive_vote_count'),
                'hit_count': _best_articles('daily', 'hit_count'),
            },
            'weekly_bests': {
                'positive_vote_count': _best_articles('weekly', 'positive_vote_count'),
                'hit_count': _best_articles('weekly', 'hit_count'),
            },
...
def _best_articles(period, best_by):
    try:
